...
function Cart() {
  ...
  const [discountTotal, setDiscountTotal] = useState(0); // 新状态用于存储总优惠金额
    ...
    useEffect(() => {
        ...
        // 获取详细商品信息并初始化状态
        const loadProducts = cart.map(item => {
        ...
        {products.map(product => (
            <Card key={product.id} title={product.title} extra={<a href="#">查看详情</a>} className="cartItem">
                <Row style={{height:'100%',paddingTop:'3px'}}>
                    ...
                    <Col span={8}>
                        <img
                            src={product.img} className="img-resize" />
                    </Col>
                    <Col span={13}>
                        <div className="flex">
                            ...
                            <div >
                                ...
                                <span
                                    style={{ color: "red", fontSize: "2em", fontWeight: "bold",textDecoration: product.checked ? "line-through" : "none"  }}
                    ...
                    {product.price.toString().split(".").length > 1
                      ...
                      : " "}
                                ...
                                {product.checked && (
                                    <Text style={{ marginLeft: 12, color: "red", fontSize: "2.3em", fontWeight: "bold" }}>
        ...
        <div className="footer">
            ...
            <div>
                <Row>
                    ...
                    <Col span={12}>
                        <Button className="vertical-center2" type="primary" disabled={selectedCount === 0} onClick={handleCheckout}>
                            去结算 ({selectedCount} 项)
                        </Button>
                    </Col>
                </Row>
